...
public class TaskAddEditActivity extends Activity implements Observer {
	...
	if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
	    addToCalendarButton = (Button) findViewById(R.id.addToCal);
	    addToCalendarButton.setVisibility(View.VISIBLE);
	    addToCalendarButton.setOnClickListener(addToCalendarListener);
	}
    }

    // TODO: fill up with data
    @SuppressLint("NewApi")
    ...
    private OnClickListener addToCalendarListener = new OnClickListener() {
