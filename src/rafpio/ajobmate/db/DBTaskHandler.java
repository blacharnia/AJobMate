...
public class DBTaskHandler extends TableHandler {
    ...
    public static final String TABLE_CREATE = "create table " + TABLE_NAME
            ...
            + KEY_START_TIME + " long, " + KEY_END_TIME + " long, " + KEY_NOTIFICATION_TIME + " long, "
            + KEY_CATEGORY + " text, " + KEY_ARCHIVE + " integer" + ");";
    ...
    public Object getItemFromCursor(Cursor cursor) {
        ...
        long notificationTime = cursor.getLong(cursor.getColumnIndex(KEY_NOTIFICATION_TIME));
        ...
        boolean archive = cursor.getInt(cursor.getColumnIndex(KEY_ARCHIVE)) == 1 ? true
                : false;
        return new Task(id, description, offerId, startTime, endTime, notificationTime, category,
                archive);
    }
    ...
    public Cursor getRecentForOffer(long mRowId) {
        return mDB.query(tableName, null, KEY_OFFER_ID + " = " + mRowId + " AND " +
        		KEY_ARCHIVE + " = 0" , null,
                null, null, null);
    }
